...
foreach ($listaConfig as $key => $value)
{
  if ($value->C_TipoUsuario->IdTipoUsuario == $_SESSION['idTipoUsuario'])
  {
    $fechaEstaLimite = $value->FechaLimite;
    break;
  }
...
$fechaLimite = new DateTime($fechaEstaLimite);
$fechaHoy = new DateTime($fecha);

if ($fechaHoy <= $fechaLimite)
{
  $interval = $fechaHoy->diff($fechaLimite);
?>
...
<div id="contenidoAll">
  ...
  <div class="row  border-bottom white-bg dashboard-header">
    ...
    <div class="col-sm-9 text-center">
      <h3><p style="color:red"><strong>POR FAVOR VERIFIQUE BIEN SUS DATOS</strong></p></h3>
      <h2 style="color:red"><strong><?php echo "El LLenado de Datos Expira en {$interval->d} día(s)"; ?></strong></h2>
    </div>
  </div>
                      ...
                      <div class="panel-body" style="display: block;">
                          <div class="tab-content">
                                  ...
                                  <form id="frmPersonalEditar">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="form-group componentePersonal" >
                              ...
                              <div class="tab-pane fade" id="HojaVida">
                                ...
                                <div class="text-center">
                                  <h2 style="color:red">
                                    Por favor sea cuidadoso al agregar contenido a su HOJA DE VIDA
                                  </h2>
                                </div>
                                    ...
                                    <div class="tab-content">
                                      ...
                                      <div class="tab-pane fade" id="Titulos">
                                        <form id="TiulosFrm">
                                          <div class="row">
                                            <div class="text-center">
                                              <h3 style="color:orange">Doctorados y Maestrias Presentar Personalmente</h3>
                                            </div>
                                            <hr>
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                              <div class="form-group">
                                                ...
                                                <div class="input-group selector">
                                                  ...
                                                  <select class="selectpicker form-control inputTitulosBk" name="tipoTituloProfesional" id="tipoTituloProfesional">
                                                    <?php foreach ($listaTipoTituloProfesional as $listaTipoTP): ?>
                                                      <?php if ($listaTipoTP->IdTipoTituloProfesional == '1' || $listaTipoTP->IdTipoTituloProfesional == '2'): ?>
...
<?php
  ...
  echo "<div class='text-center' style='color:red'><h1><strong>Fecha Limite de Edicion EXPIRADA</strong></h1></div>";
  ?>
