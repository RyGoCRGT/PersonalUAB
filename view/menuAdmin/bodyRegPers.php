<div id="contenidoAll">
  ...
  <div class="row  border-bottom white-bg dashboard-header">
      ...
      <div class="col-sm-3">
          <h2>Personal-UAB </h2>
          <small><a href="index.php" class="btn btn-success">Home</a></small>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-sm-8 col-md-8">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              <span class="input-group-addon" id="sizing-addon2"><i class="fa fa-user"></i></span>
                                              <input id="lugExp" type="text" class="form-control" placeholder="Lugar Exp CI: " aria-describedby="sizing-addon2" name="lugExp" required>
                                            </div>
                                          </div>
