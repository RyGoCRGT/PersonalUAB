<?php
    ...
    if (isset($_GET['datos']))
    {
      ...
      header("Content-Disposition: attachment; filename=Formulario_$nameFile.xls");
      ...
      <html>
        ...
        <body>
            ...
            <div class="thumbnail">
              <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4">
                  <center><img src="file://C:/wamp64/www/PersonalUAB/view/libs/multimedia/img/design/uab.png" alt="uab-logo" width="80" height="80" class="img img-responsive img-rounded"></center>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4">
                  <?php
                    list($nada,$ruta) = explode("/wamp64/www/PersonalUAB/view/libs/multimedia/img/personal/", $personal->Ruta);
                  ?>
                  <center><img src="‪file:///C:/wamp64/www/PersonalUAB/view/libs/multimedia/img/personal/<?php echo $ruta; ?>" alt="persona" class="img img-responsive img-rounded" width="110" height="110"></center>
                </div>
              </div>
              <div class="row">
          ...
          <script src="file://C:/wamp64/www/PersonalUAB/view/libs/js/bootstrap.min.js"></script>
        </body>
      </html>
      <?php
