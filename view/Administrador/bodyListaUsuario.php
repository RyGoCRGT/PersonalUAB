                      ...
                      <div class="panel panel-primary">
                        <div class="panel-heading">
                          ...
                          <div class="pull-right">
                            ...
                            <span class="clickable filter btn btn-info efec" data-toggle="tooltip" title="Click aqui para buscar un Usuario" data-container="body">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <?php if ($usuario['estado'] == 1): ?>
                                      <form action="index.php?modo=UsuarioDown" method="post">
                                    ...
                                    <?php else: ?>
                                      <form action="index.php?modo=UsuarioUp" method="post">
                                        <input type="hidden" name="id" value="<?php echo $usuario['idUsuario']; ?>">
