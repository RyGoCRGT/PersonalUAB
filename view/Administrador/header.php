        ...
        <nav class="navbar-default navbar-static-side nav-side-menu" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav " id="side-menu">
                    ...
                    <li>
                        <a href="index.php?modo=documentos"><i class="fa fa-file-pdf-o"></i> <span class="nav-label">Documetos</span></a>
                    </li>
                    <li>
                        <a href="index.php?modo=config"><i class="fa fa-gear"></i> <span class="nav-label">Configuraciones</span></a>
                    </li>
                    <li>
                        <a href="index.php?modo=reportes"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Reportes</span></a>
                    </li>
                </ul>
            </div>
        </nav>
