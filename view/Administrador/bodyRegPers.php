                                      ...
                                      <div class="col-sm-10 col-md-8">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-sm-6 col-md-6 ">
                                            <center>
                                              <div class="imgFoto">
                                                <input id="fotoPersonal" type="file" style="opacity:0" class="form-control personalInputCtr" name="fotoPersonal" required>
                                              </div>
                                            </center>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="input-group" >
                                            ...
                                            <input id="fechaBau" type="text" class="form-control personalInputCtr datepicker" data-date-format="yyyy/mm/dd" placeholder="Fecha de Bautizmo:  AAAA/MM/DD" aria-describedby="sizing-addon2" name="fechaBau" required>
                                          </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="input-group" >
                                            <span class="input-group-addon" style="background: red; color:white" id="sizing-addon2"><i class="fa fa-calendar"></i></span>
                                            <input id="fechaIngres" type="text" class="form-control personalInputCtr datepicker" data-date-format="yyyy/mm/dd" placeholder="Fecha de Ingreso UAB:  AAAA/MM/DD" name="fechaIngres" required>
                                          </div>
                                        </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                              <div class="form-group">
                                                ...
                                                <div class="input-group exportarArchivo">
                                                  <input type="file" class="form-control exportarArchivoFile" name="respaldoTitulo" id="respaldoTitulo" required>
                                                </div>
                                                <div class="nameFileImg"></div>
                                              </div>
                                            </div>
